...
namespace MagicCollection.Data.Migrations
{
    ...
    [Migration("20231123060207_ScryfallDeletedFlag")]
    partial class ScryfallDeletedFlag
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MagicCollection.Data.Entities.Edition", b =>
                {
                    ...
                    b.Property<string>("TypeIdentifier")
                        ...
                        .HasColumnName("type_identifier");

                    b.HasKey("Id")
                        .HasName("pk_editions");

                    b.HasIndex("TypeIdentifier")
                        .HasDatabaseName("ix_editions_type_identifier");

                    b.ToTable("editions", (string)null);
                });

            modelBuilder.Entity("MagicCollection.Data.Entities.EditionType", b =>
                {
            ...
            modelBuilder.Entity("MagicCollection.Data.Entities.Print", b =>
                {
                    ...
                    b.Property<bool>("ScryfallDeleted")
                        .HasColumnType("boolean")
                        .HasColumnName("scryfall_deleted");
            ...
            modelBuilder.Entity("MagicCollection.Data.Entities.Edition", b =>
                {
                    b.HasOne("MagicCollection.Data.Entities.EditionType", "Type")
                        .WithMany()
                        .HasForeignKey("TypeIdentifier")
                        .HasConstraintName("fk_editions_edition_type_type_temp_id");
