...
namespace MagicCollection.Data.Migrations
{
    ...
    [Migration("20230319213920_MultiplePrices")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MagicCollection.Data.Entities.CardEntry", b =>
                {
                    ...
                    b.HasIndex("PrintId")
                        .HasDatabaseName("ix_card_entries_print_id");
            ...
            modelBuilder.Entity("MagicCollection.Data.Entities.Price", b =>
                {
                    b.Property<Guid>("PrintId")
                        .HasColumnType("uuid")
                        .HasColumnName("print_id");
                    ...
                    b.HasIndex("TreatmentId")
                        .HasDatabaseName("ix_price_treatment_id");
            ...
            modelBuilder.Entity("MagicCollection.Data.Entities.Print", b =>
                {
                    ...
                    b.HasIndex("LanguageIdentifier")
                        .HasDatabaseName("ix_prints_language_identifier");
            ...
            modelBuilder.Entity("PrintTreatment", b =>
                {
                    b.Property<string>("AvailableTreatmentsIdentifier")
                        .HasColumnType("character varying(16)")
                        .HasColumnName("available_treatments_identifier");

                    b.Property<Guid>("PrintsId")
                        .HasColumnType("uuid")
                        .HasColumnName("prints_id");

                    b.HasKey("AvailableTreatmentsIdentifier", "PrintsId")
                        .HasName("pk_print_treatment");

                    b.HasIndex("PrintsId")
                        .HasDatabaseName("ix_print_treatment_prints_id");
            ...
            modelBuilder.Entity("MagicCollection.Data.Entities.CardEntry", b =>
                {
                    ...
                    b.HasOne("MagicCollection.Data.Entities.Treatment", "Treatment")
                        ...
                        .HasConstraintName("fk_card_entries_treatments_treatment_temp_id");
            ...
            modelBuilder.Entity("MagicCollection.Data.Entities.Price", b =>
                {
                    b.HasOne("MagicCollection.Data.Entities.Print", "Print")
                        ...
                        .IsRequired()
                        .HasConstraintName("fk_price_prints_print_id");
                    ...
                    b.HasOne("MagicCollection.Data.Entities.Treatment", "Treatment")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_price_treatments_treatment_id");
            ...
            modelBuilder.Entity("MagicCollection.Data.Entities.Print", b =>
                {
                    ...
                    b.HasOne("MagicCollection.Data.Entities.Language", "Language")
                        ...
                        .HasConstraintName("fk_prints_languages_language_identifier");
            ...
            modelBuilder.Entity("PrintTreatment", b =>
                {
                    b.HasOne("MagicCollection.Data.Entities.Treatment", null)
                        .WithMany()
                        .HasForeignKey("AvailableTreatmentsIdentifier")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_print_treatment_treatments_available_treatments_identifier");

                    b.HasOne("MagicCollection.Data.Entities.Print", null)
                        .WithMany()
                        .HasForeignKey("PrintsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_print_treatment_prints_prints_id");
                });
